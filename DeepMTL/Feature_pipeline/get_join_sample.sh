...
echo "make_sample on ${HADOOP_ROOT}/lambdaji/aliccp/${task_type}/sample ..."

INPUT_PATH=${HADOOP_ROOT}/lambdaji/aliccp/${task_type}/*
OUTPUT_PATH=${HADOOP_ROOT}/lambdaji/aliccp/${task_type}/sample
...
-input ${INPUT_PATH} \
-output ${OUTPUT_PATH} \
-mapper "python get_join_mapper.py" \
...
echo "make_sample on ${HADOOP_ROOT}/lambdaji/aliccp/${task_type}/sample stat:${?}"
