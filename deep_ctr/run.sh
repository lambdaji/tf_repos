...
python PNN.py --model_type=Outer --learning_rate=0.001 --optimizer=Adam --num_epochs=1 --embedding_size=32 --batch_size=128 --field_size=39 --feature_size=117581 --deep_layers=256,128 --dropout=0.5,0.5 --l2_reg=0.001 --log_steps=1000 --num_threads=8 --model_dir=${model_dir}/OPNN/ --data_dir=${data_dir}
