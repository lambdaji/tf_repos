...
python DCN.py --learning_rate=0.0005 --optimizer=Adam --num_epochs=1 --embedding_size=32 --batch_size=256 --field_size=39 --feature_size=117581 --deep_layers=512,256 --cross_layers=3 --dropout=0.8,0.8 --l2_reg=0.00001 --log_steps=1000 --num_threads=8 --model_dir=${model_dir}/DCN/ --data_dir=${data_dir}
...
python DeepMVM.py --learning_rate=0.0005 --optimizer=Adam --num_epochs=1 --embedding_size=32 --batch_size=256 --field_size=39 --feature_size=117581 --deep_layers=512,256 --cross_layers=3 --dropout=0.8,0.8 --l2_reg=0.00001 --log_steps=1000 --num_threads=8 --model_dir=${model_dir}/DCN/ --data_dir=${data_dir}
