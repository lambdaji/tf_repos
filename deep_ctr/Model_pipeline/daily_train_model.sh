...
python PNN.py --model_type=FNN --learning_rate=0.005 --optimizer=Adam --num_epochs=1 --embedding_size=16 --batch_size=128 --field_size=39 --feature_size=117581 --deep_layers=300,100 --dropout=0.5,0.5 --l2_reg=0.1 --log_steps=1000 --num_threads=8 --model_dir=${model_dir}/FNN/ --data_dir=${data_dir}
python PNN.py --model_type=Inner --learning_rate=0.005 --optimizer=Adam --num_epochs=1 --embedding_size=16 --batch_size=128 --field_size=39 --feature_size=117581 --deep_layers=300,100 --dropout=0.5,0.5 --l2_reg=0.1 --log_steps=1000 --num_threads=8 --model_dir=${model_dir}/IPNN/ --data_dir=${data_dir}
